...
CommandLine:
    ...
    python ~/code/timerit/dev/gen_typed_stubs.py
...
def generate_typed_stubs():
    ...
    monkeytype stub timerit.util_dict
    ...
    ubelt_dpath = dirname(timerit.__file__)
...
if __name__ == '__main__':
    """
    CommandLine:
        python ~/code/timerit/dev/gen_type_stubs.py
        python ~/code/timerit/dev/gen_type_subs.py
    """
