...
NAME = "timerit"
INIT_PATH = "timerit/__init__.py"
VERSION = parse_version("timerit/__init__.py")
...
if __name__ == "__main__":
    ...
    setupkw["url"] = "https://github.com/Erotemic/timerit"
    setupkw["description"] = "A powerful multiline alternative to timeit"
    ...
    setupkw["package_data"] = {"timerit": ["py.typed", "*.pyi"]}
    setup(**setupkw)
