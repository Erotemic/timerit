...
Notes:
    ...
    rm -rf ~/code/timerit/docs/source/auto
    cd ~/code/timerit/docs
    sphinx-apidoc --private --separate --force --output-dir ~/code/timerit/docs/source/auto ~/code/timerit/timerit
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/timerit/advanced/
        ...
        Enter the following information:
            Set the Repository NAME: timerit
            Set the Repository URL: https://github.com/Erotemic/timerit

        Make sure you have a .readthedocs.yml file

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/timerit/integrations/create/
        ...
        Then go to
            ...
            https://github.com/Erotemic/timerit/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/timerit/versions/
"""
#
...
mod_dpath = join(repo_dpath, 'timerit')
...
# html_logo = '.static/timerit.svg'
# html_favicon = '.static/timerit.ico'
...
latex_documents = [
    (master_doc, 'timerit.tex', 'timerit Documentation', 'Jon Crall', 'manual'),
]
...
man_pages = [(master_doc, 'timerit', 'timerit Documentation', [author], 1)]
