...
Notes:
    ...
    sphinx-apidoc --private -f -o ~/code/timerit/docs/source ~/code/timerit/timerit --separate
    make html
...
modpath = join(dirname(dirname(dirname(__file__))), 'timerit', '__init__.py')
...
latex_documents = [
    (master_doc, 'timerit.tex', 'timerit Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'timerit', 'timerit Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'timerit', 'timerit Documentation',
     author, 'timerit', 'One line description of project.',
     'Miscellaneous'),
]
